...
const images = [
    ...
    ['Create your own monsters or use existing ones', s3],
    ['Create an encounter and add monsters. Click on their names and HP to edit them before or during the encounter', s4],
    ['Once ready, share your campaign with your friends and let them join. Then let the battle begin!', s5],
]
    ...
    return (
        <Page>
            <Container text className={classes.container}>
                ...
                <p>
                    I play and GM D&D and I realised half of our sessions are spent communicating numbers when we could
                ...
                <p>
                    To ease these issues I created the app that is before you, Crit Hit. It was primarily designed to help
